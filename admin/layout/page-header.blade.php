<header class="bg-white header header-md navbar navbar-fixed-top-xs box-shadow">
            <div class="navbar-header aside-md dk">
                ...
                <a href="index.html" class="navbar-brand"> <img src="{{URL::to('public/admin')}}/images/logo.png" class="m-r-sm" alt="scale"> <span class="hidden-nav-xs">Scale</span> </a>
            ...
            <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user user">
                    ...
                    <section class="dropdown-menu aside-xl animated flipInY">
                        <section class="panel bg-white">
                            ...
                            <div class="list-group list-group-alt">
                                <a href="#" class="media list-group-item"> <span class="pull-left thumb-sm"> <img src="{{URL::to('public/admin')}}/images/a0.png" alt="..." class="img-circle"> </span> <span class="media-body block m-b-none"> Use awesome animate.css<br> <small class="text-muted">10 minutes ago</small> </span> </a>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb-sm avatar pull-left"> <img src="{{URL::to('public/admin')}}/images/a0.png" alt="..."> </span> John.Smith <b class="caret"></b> </a>
